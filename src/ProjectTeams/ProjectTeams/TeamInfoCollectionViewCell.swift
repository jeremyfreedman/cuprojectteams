...
//        TeamTypeLabel.anchor(top: teamImageView.bottomAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: -30, paddingLeft: 0, paddingBottom: 0, paddingRight: 0)
        TeamTypeLabel.anchor(top: teamImageView.bottomAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 22)
        
        
        
        
        NSLayoutConstraint.activate([
            teamImageView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: -100),
            teamImageView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: 100)
            ])
        
//         Project Team title
        NSLayoutConstraint.activate([
//            TeamNameLabel.centerXAnchor.constraint(equalTo: teamImageView.centerXAnchor),
            TeamTypeLabel.topAnchor.constraint(equalTo: teamImageView.bottomAnchor, constant: 45),
            TeamTypeLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: 0),
